...
public class mainPlayerTable extends JFrame implements KeyListener  {

		private JPanel tablepanel;
		private JTextField search;
		private JTable table;

		public mainPlayerTable(String title, int width, int height) {
			setTitle(title);
			setSize(863, 574);
//			setLocation(300, 300);
			...
			String[][] data= MainPlayerList.getPlayers();
		...
		public static void main(String[] args) {
			new mainPlayerTable("선발선수", 855, 400);
		}
